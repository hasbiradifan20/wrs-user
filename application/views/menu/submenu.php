    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newSubMenuModal"><i
                    class="fas fa-plus"> Add new Submenu</i></a>
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="" class="badge badge-success" data-toggle="modal"
                                    data-target="#editMenuModal">Edit</a>
...
<!-- Modal Edit -->
<div class="modal fade" id="hapusMenuModal" tabindex="-1" role="dialog" aria-labelledby="hapusMenuModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
